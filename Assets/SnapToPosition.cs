...
public class SnapToPosition : MonoBehaviour
{
    ...
    void Update()
    {
        // if (isLerping) {
        //     // position lerp
        //     Debug.Log("startRot:" + startRot.ToString() + " endRot: " + endRot.ToString());
        ...
        //         Debug.Log("rotating");
        //         transform.rotation = Quaternion.Slerp(startRot, endRot, timeCount);
        ...
        if (Input.GetKeyDown(KeyCode.Alpha1)) {
            ...
            endPos = new Vector3(0f, -7.66f, 0f);
            // endRot = Quaternion.Euler(-90, 0 , 0);
            transform.LookAt(Vector3.down * 100);
            StartLerp();
